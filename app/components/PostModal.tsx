  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden" onClick={onClose}>
      ...
      >
        ...
        <button
          onClick={onClose}
          className="sticky top-4 left-full -ml-12 p-2 text-gray-500 hover:text-gray-900 focus:outline-none"
        >
          ✕
        </button>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center text-lg font-bold text-gray-700">
              {postState.users?.username?.charAt(0).toUpperCase() || 'U'}
            </div>
            <div>
              ...
              {isLoadingComments ? (
                ...
                comments.map((comment: any) => (
                  <div key={comment.id} className="flex gap-3">
                    <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center text-xs font-bold text-gray-700 flex-shrink-0">
